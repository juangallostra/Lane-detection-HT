...
%
%
% tested on MATLAB R2016 a


%% Video Loading
reader = vision.VideoFileReader('test_video.avi'); % Change by the name of the video to test
...
H_PEAKS = 20;			% number of peaks
TH_PEAKS = 0.2;			% peaks threshold
ROI_correction = 60;	% number of pixels below the half of the video
theta_inp = 55;
ROI_width = [1:w];
ROI_height = [1:h];
...
straight = true;
% Angles can be adjusted for a better performance
UNION_ANGLE = 30 ;
UPPER_SPLIT_LIMIT = -37;
LOWER_SPLIT_LIMIT = -75;


% NOTE: l stands for RIGHT and r stands for LEFT
best_r_lane = [w/2; w/2];
best_l_lane = [w/4; 3*w/4];
